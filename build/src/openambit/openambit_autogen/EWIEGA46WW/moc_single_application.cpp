...
#include <memory>
#include "../../../../../src/openambit/single_application.h"
...
void SingleApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SingleApplication::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SingleApplication::messageAvailable)) {
                *result = 0;
                return;
            }
        }
