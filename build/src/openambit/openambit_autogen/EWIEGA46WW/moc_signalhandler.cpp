...
#include <memory>
#include "../../../../../src/openambit/signalhandler.h"
...
QT_MOC_LITERAL(1, 14, 14), // "signalReceived"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 6), // "signal"
QT_MOC_LITERAL(4, 37, 16) // "POSIX_socketRecv"

    },
    "SignalHandler\0signalReceived\0\0signal\0"
    "POSIX_socketRecv"
};
...
void SignalHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->POSIX_socketRecv(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignalHandler::signalReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SignalHandler::signalReceived(int _t1)
{
