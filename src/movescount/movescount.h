...
public:
    ...
    void setOrbitSource(int source);       // 0=OpenIGS, 1=localFile, 2=Movescount
    void setOrbitLocalPath(QString path);
...
private:
    ...
    int orbitSource = 0;        // 0=OpenIGS, 1=localFile, 2=Movescount
    QString orbitLocalPath;
